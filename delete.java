...
class delete implements ActionListener
{
	...
	{	
		...
		fr.setLayout(null);
		fr.setContentPane(new JLabel(new ImageIcon("images/deleteform.png")));
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		if(ae.getSource()==b2)
		{
			...
			else if(b2.getLabel().equals("Delete"))
			{
				...
				if(z==0)
				{
					...
					{
						con = Dao.createconnection();
						ps = con.prepareStatement("delete from sms_record where student_id=?");
						ps.setString(1,t1.getText());
						int w = ps.executeUpdate();
						if(w>0)
						{
							File fe = new File("photo/"+t1.getText()+".jpg");
							fe.delete();
							JOptionPane.showMessageDialog(fr,"Record Delete Successfully");
							reset();
						}
						con.close();
					}

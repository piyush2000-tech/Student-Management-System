...
class display implements ActionListener
{
	...
	{	
		...
		fr.setLayout(null);
		fr.setContentPane(new JLabel(new ImageIcon("images/displayform.png")));
		...
		b1 = new JButton("Next",new ImageIcon("images/next1.png"));
		b2 = new JButton("Prev",new ImageIcon("images/previous1.png"));
	...
	public void connect()
	{
		try
		{
			...
			ps = con.prepareStatement("select * from sms_record",ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_READ_ONLY);
			rs = ps.executeQuery();
		}
		catch(Exception e)
		{
	...
	public void actionPerformed(ActionEvent ae)
	{
		if(ae.getSource()==b1)
		{
			...
			{
				JOptionPane.showMessageDialog(fr,"Last Record");
			}
		}
		...
		if(ae.getSource()==b2)
		{
			...
			{
				JOptionPane.showMessageDialog(fr,"First Record");
			}
		}
	}
}
